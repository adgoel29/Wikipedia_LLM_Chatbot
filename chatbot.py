# """
# WIKIPEDIA + OLLAMA CHATBOT
# - Uses gemma3:1b-instruct
# - Langfuse v2.60.10 (old API)
# """
...
#         self.lf = Langfuse()   # uses env vars
...
#             input={"question": question, "topic": topic}
#         )
...
#         print(f"📄 Fetched content for page: {content}")
#         if not content:
...
# def main():
#     print("=" * 60)
#     print("🤖 Wikipedia Chatbot + Langfuse v2.60.10 (Legacy API)")
#     print("=" * 60)
